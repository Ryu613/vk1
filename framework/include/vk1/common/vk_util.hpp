...
inline void transition_image(VkCommandBuffer cmd,
  ...
  // all command is unefficient but now is ok
  ...
  imageBarrier.subresourceRange = init::image_subresource_range(aspectMask);
...
inline void copy_image_to_image(
    VkCommandBuffer cmd, VkImage source, VkImage destination, VkExtent2D srcSize, VkExtent2D dstSize) {
